...
@section('head_meta')
<!-- ============================================================
  SEO META — UI/UX & Branding Service Page
  Targets: India (Pune, Mumbai, Delhi, Bangalore), USA, Dubai
============================================================ -->
<title>UI/UX Design & Branding Services | Veerhan – India, USA & Dubai</title>
<meta name="description" content="Veerhan provides UI/UX design and branding services for businesses in India, the USA, and Dubai. UX research, wireframes, high-fidelity design, design systems, and strategic brand identity development.">
<meta name="keywords" content="ui ux design agency India, branding agency USA, product design Dubai, user experience design Pune, brand identity design Mumbai, design system agency, ux research services, app ui design company, branding studio India">
...
<meta property="og:title" content="UI/UX Design & Branding Services | Veerhan">
<meta property="og:description" content="Create memorable brands and conversion-focused digital experiences with Veerhan's UI/UX and branding services.">
<meta property="og:url" content="https://veerhan.com/services/ui-ux-design-branding">
<meta property="og:site_name" content="Veerhan">
<meta property="og:image" content="https://veerhan.com/og/ui-ux-branding-service.jpg">

<!-- Twitter Card -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="UI/UX Design & Branding | Veerhan">
<meta name="twitter:description" content="UX research, interface design, design systems, and branding strategy for India, USA, and Dubai businesses.">

<!-- Canonical -->
<link rel="canonical" href="https://veerhan.com/services/ui-ux-design-branding">

<!-- Hreflang for region targeting -->
<link rel="alternate" hreflang="en-in" href="https://veerhan.com/services/ui-ux-design-branding">
<link rel="alternate" hreflang="en-us" href="https://veerhan.com/services/ui-ux-design-branding">
<link rel="alternate" hreflang="en-ae" href="https://veerhan.com/services/ui-ux-design-branding">
<link rel="alternate" hreflang="x-default" href="https://veerhan.com/services/ui-ux-design-branding">
...
<script type="application/ld+json">
{
  ...
  "description": "UI/UX design and branding services for businesses in India, the USA, and Dubai. Includes UX research, wireframes, high-fidelity interfaces, design systems, brand strategy, and visual identity creation.",
  "provider": {
    "@type": "Organization",
    "name": "Veerhan",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How much do UI/UX and branding services cost?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "At Veerhan, UI/UX and branding projects typically start from ₹25,000 and scale based on complexity, screen count, and brand deliverables."
      }
    },
    {
      "@type": "Question",
      "name": "Do you offer UI/UX and branding services in Dubai?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Veerhan supports UAE clients with remote-first collaboration and delivers multilingual-ready UX and premium brand identity systems."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most UI/UX and branding projects take 3–8 weeks depending on scope, number of flows, and review cycles."
      }
    },
    {
      "@type": "Question",
      "name": "Can you handle UX and full brand identity together?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. We provide end-to-end support from UX strategy and interface design to logo systems, typography, color systems, and brand guidelines."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "UI/UX Design & Branding", "item": "https://veerhan.com/services/ui-ux-design-branding" }
  ]
}
</script>
@endsection
...
<!-- ============================================================
  SERVICE HERO
============================================================ -->
<section class="service-hero" id="home" aria-label="UI and UX Design and Branding Service Introduction">
  ...
  <div class="service-hero-inner">
    ...
    <div class="service-hero-left">
      <div class="service-hero-label" id="heroLabel">UI/UX Design & Branding</div>
      <h1 class="service-hero-title" id="heroTitle">
        Design Systems<br><span class="accent">That Convert.</span><br>Brand Stories<br><span class="accent">That Stick.</span>
      </h1>
      <p class="service-hero-sub" id="heroSub">
        We craft research-led UX and strategic brand identities for businesses in India, the USA, and Dubai. Every screen and brand element is designed to improve trust, usability, and conversion.
      </p>
      <div class="hero-actions" id="heroActions">
        <a href="{{ route('contact') }}#contact" class="btn-primary">Start Design Sprint →</a>
        <a href="#portfolio" class="btn-secondary">View Design Cases ↗</a>
      </div>
      <div class="hero-stats-strip" id="heroStats">
        <div class="hstat">
          <div class="hstat-num">220<span>+</span></div>
          <div class="hstat-label">UX Flows Delivered</div>
        </div>
        <div class="hstat">
          <div class="hstat-num">37<span>%</span></div>
          <div class="hstat-label">Avg. Conversion Lift</div>
        </div>
        <div class="hstat">
          <div class="hstat-num">5.0<span>/5</span></div>
          <div class="hstat-label">Avg. Client Rating</div>
        </div>
        <div class="hstat">
    ...
    <div class="service-hero-visual" id="heroVisual">
      <div class="hero-visual-inner">
        <div style="width:88%; background:#fff; border-radius:14px; box-shadow:0 24px 80px rgba(0,0,0,0.12); padding:16px;">
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:10px;">
            <strong style="font-size:13px;">UX & Brand Board</strong>
            <span style="font-size:11px; color:#6B6B6B;">Prototype v4</span>
          </div>
          <div style="display:grid; grid-template-columns:1.2fr 1fr; gap:10px;">
            <div style="background:linear-gradient(135deg,#F46B1B,#D4520A); border-radius:12px; min-height:170px; position:relative;">
              <div style="position:absolute; top:10px; left:10px; font-size:11px; color:#fff; opacity:0.8;">Mobile Onboarding Flow</div>
              <div style="position:absolute; bottom:10px; right:10px; background:rgba(255,255,255,0.16); color:#fff; border-radius:100px; font-size:11px; padding:4px 10px;">8 Screens</div>
            </div>
            <div style="display:flex; flex-direction:column; gap:8px;">
              <div style="background:#F5F5F3; border-radius:10px; padding:10px;">
                <div style="font-size:11px; color:#6B6B6B; margin-bottom:4px;">Typography</div>
                <div style="font-size:16px; font-weight:700;">Syne / DM Sans</div>
              </div>
              <div style="background:#F5F5F3; border-radius:10px; padding:10px;">
                <div style="font-size:11px; color:#6B6B6B; margin-bottom:6px;">Color System</div>
                <div style="display:flex; gap:6px;">
                  <span style="width:18px; height:18px; border-radius:4px; background:#F46B1B; display:block;"></span>
                  <span style="width:18px; height:18px; border-radius:4px; background:#D4520A; display:block;"></span>
                  <span style="width:18px; height:18px; border-radius:4px; background:#0E0E0E; display:block;"></span>
                  <span style="width:18px; height:18px; border-radius:4px; background:#FAFAF8; border:1px solid #E8E4DF; display:block;"></span>
                </div>
              </div>
              <div style="background:#FFF0E6; border-radius:10px; padding:10px;">
                <div style="font-size:11px; color:#6B6B6B;">Design QA</div>
                <div style="font-size:16px; font-weight:700;">AA Ready</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="hero-visual-chips">
        <div class="hero-chip"><span class="dot"></span> UX Research</div>
        <div class="hero-chip"><span class="dot"></span> Figma Prototypes</div>
        <div class="hero-chip"><span class="dot"></span> Design Systems</div>
        <div class="hero-chip"><span class="dot"></span> Brand Identity</div>
      </div>
    </div>
  </div>
</section>
...
<div class="marquee-section" aria-hidden="true">
  <div class="marquee-track">
    <div class="marquee-item">UX Research <span class="sep">✦</span></div>
    <div class="marquee-item">Wireframes <span class="sep">✦</span></div>
    <div class="marquee-item">User Flows <span class="sep">✦</span></div>
    <div class="marquee-item">UI Prototyping <span class="sep">✦</span></div>
    <div class="marquee-item">Design Systems <span class="sep">✦</span></div>
    <div class="marquee-item">Brand Strategy <span class="sep">✦</span></div>
    <div class="marquee-item">Visual Identity <span class="sep">✦</span></div>
    <div class="marquee-item">Mobile App UX <span class="sep">✦</span></div>
    <div class="marquee-item">Interaction Design <span class="sep">✦</span></div>
...
<section class="what-we-build" id="what-we-build" aria-labelledby="buildTitle">
  <div class="section-label">What We Design</div>
  <h2 class="section-title" id="buildTitle">User Experiences &<br><span class="accent">Brand Systems</span></h2>
  <p class="section-sub">From UX research to complete visual identity systems, we design digital products and brands that feel intuitive and memorable.</p>
  ...
  <div class="build-grid">
    ...
    <div class="build-card">
      ...
      <div class="build-list">
        ...
        <div class="build-list-item">Brand voice and tone</div>
    ...
    <div class="build-card">
      ...
      <p>Scalable design systems and component libraries built for complex products, dashboards, and SaaS platforms.</p>
      <div class="build-list">
...
<section class="tech-stack" id="tech-stack" aria-labelledby="techTitle">
  <div class="tech-header">
    <div class="section-label">Design Stack</div>
    <h2 class="section-title" id="techTitle">Tools Behind<br><span class="accent">Great Experiences</span></h2>
...
<section class="process" id="process" aria-labelledby="processTitle">
  ...
  <h2 class="section-title" id="processTitle">Our <span class="accent">6-Step</span><br>Design Process</h2>
...
<section class="ai-edge" id="ai" aria-labelledby="aiTitle">
  ...
  <div class="ai-split">
    ...
    <div class="ai-text-content" id="aiText">
      <h2 class="section-title" id="aiTitle">Designed Better.<br>Built <span class="accent">for Humans.</span></h2>
...
<section class="portfolio" id="portfolio" aria-labelledby="portfolioTitle">
  <div class="portfolio-header">
    <div>
      ...
      <h2 class="section-title" id="portfolioTitle">Recent UX & <span class="accent">Brand Projects</span></h2>
    </div>
    ...
    <div class="portfolio-track" id="portfolioTrack">
      ...
      <div class="portfolio-card">
        ...
        <div class="portfolio-info">
          ...
          <p>SaaS UX redesign for a Texas-based client focused on faster onboarding and clearer operational workflows.</p>
        </div>
      </div>
...
<section class="regions" id="regions" aria-labelledby="regionsTitle">
  ...
  <div class="regions-grid">
    ...
    <div class="region-card">
      ...
      <p>Indian businesses trust Veerhan for practical UX and branding that balances clarity, culture, and conversion outcomes.</p>
...
<section class="pricing" id="pricing" aria-labelledby="pricingTitle">
  ...
  <div class="pricing-grid">
    ...
    <div class="pricing-card featured">
      ...
      <a href="{{ route('contact') }}#contact" class="btn-pricing">Start Your Design Plan →</a>
    </div>
    ...
    <div class="pricing-card">
      ...
      <div class="pricing-features">
        ...
        <div class="pricing-feat"><div class="pricing-feat-check">✓</div>Design system architecture</div>
  ...
  <div class="faq-list" role="list">
    ...
    <div class="faq-item" role="listitem">
      <div class="faq-q" role="button" aria-expanded="false" tabindex="0">
        How much do UI/UX and branding services cost?
        <span class="faq-icon">+</span>
      </div>
      <div class="faq-a"><div class="faq-a-inner">UI/UX and branding engagements usually start from ₹25,000 and scale based on research depth, screen count, and brand deliverables. We provide detailed scope and milestone-based pricing before kickoff.</div></div>
    </div>
    ...
    <div class="faq-item" role="listitem">
      ...
      <div class="faq-a"><div class="faq-a-inner">Most focused UX sprints take 2–3 weeks, while full UX and branding projects take 4–8 weeks depending on product complexity and feedback cycles.</div></div>
    </div>
    ...
    <div class="faq-item" role="listitem">
      ...
      <div class="faq-a"><div class="faq-a-inner">Yes. We collaborate with teams across India, the US, and UAE using remote-first workflows, timezone overlap, and structured review checkpoints.</div></div>
    </div>
    ...
    <div class="faq-item" role="listitem">
      ...
      <div class="faq-a"><div class="faq-a-inner">Yes. We design with conversion intent through clear information hierarchy, reduced friction, trust cues, and action-focused interaction patterns.</div></div>
    </div>

    <div class="faq-item" role="listitem">
      <div class="faq-q" role="button" aria-expanded="false" tabindex="0">
        Can you handle both UX and complete brand identity?
        <span class="faq-icon">+</span>
      </div>
      <div class="faq-a"><div class="faq-a-inner">Yes. We provide both UX design and complete brand identity work including logo systems, typography, color systems, and usage guidelines.</div></div>
    </div>

    <div class="faq-item" role="listitem">
      <div class="faq-q" role="button" aria-expanded="false" tabindex="0">
        What support do you provide after handoff?
        <span class="faq-icon">+</span>
      </div>
      <div class="faq-a"><div class="faq-a-inner">We offer post-handoff design QA, feature expansion support, and design governance retainers to keep your product and brand consistent as you scale.</div></div>
    </div>
...
@include('partials.contact-form', ['serviceName' => 'UI/UX & Branding', 'pageSource' => 'UI/UX Service Page', 'formId' => 'uiux'])

<!-- CTA STRIP -->
<div class="cta-strip" aria-label="Call to action">
  <div class="cta-strip-text">
    <h2>Ready to Upgrade Your User Experience?</h2>
    <p>Get a free UX and brand audit with actionable priorities in 24 hours.</p>
  </div>
