...
@section('head_meta')
<!-- ============================================================
  SEO META — Web Security & Protection Service Page
  Targets: India (Pune, Mumbai, Delhi, Bangalore), USA, Dubai
============================================================ -->
<title>Web Security & Protection Services | Veerhan – India, USA & Dubai</title>
<meta name="description" content="Veerhan provides web security and protection services for businesses in India, the USA, and Dubai. Security audits, malware cleanup, vulnerability patching, WAF setup, and ongoing website hardening.">
<meta name="keywords" content="website security services India, web security agency USA, malware removal Dubai, vulnerability assessment Pune, wordpress security hardening Mumbai, website firewall setup, ssl implementation services, cyber security for websites">
...
<meta property="og:title" content="Web Security & Protection Services | Veerhan">
<meta property="og:description" content="Protect your website from malware, hacks, and data risk with Veerhan's web security and protection services.">
<meta property="og:url" content="https://veerhan.com/services/web-security-protection">
<meta property="og:site_name" content="Veerhan">
<meta property="og:image" content="https://veerhan.com/og/web-security-service.jpg">

<!-- Twitter Card -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Web Security & Protection | Veerhan">
<meta name="twitter:description" content="Security audits, malware cleanup, firewall setup, and ongoing web protection services.">

<!-- Canonical -->
<link rel="canonical" href="https://veerhan.com/services/web-security-protection">

<!-- Hreflang for region targeting -->
<link rel="alternate" hreflang="en-in" href="https://veerhan.com/services/web-security-protection">
<link rel="alternate" hreflang="en-us" href="https://veerhan.com/services/web-security-protection">
<link rel="alternate" hreflang="en-ae" href="https://veerhan.com/services/web-security-protection">
<link rel="alternate" hreflang="x-default" href="https://veerhan.com/services/web-security-protection">
...
<script type="application/ld+json">
{
  ...
  "description": "Web security and protection services for businesses in India, the USA, and Dubai. Includes vulnerability assessment, malware removal, firewall setup, security monitoring, and hardening.",
  "provider": {
    "@type": "Organization",
    "name": "Veerhan",
  ...
  "serviceType": "Web Security and Protection",
  "offers": {
    "@type": "AggregateOffer",
    "priceCurrency": "INR",
    "lowPrice": "12000",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How much do web security services cost?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Web security projects typically start from ₹12,000 for focused audit and cleanup scopes and scale based on website size, risk level, and monitoring needs."
      }
    },
    {
      "@type": "Question",
      "name": "Do you provide website security services in Dubai?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. We support UAE businesses with remote-first security audits, remediation, and ongoing hardening services."
      }
    },
    {
      "@type": "Question",
      "name": "How long does a security audit and fix cycle take?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Initial audits are usually completed in 2–5 days. Critical remediation timelines depend on issue severity and platform complexity."
      }
    },
    {
      "@type": "Question",
      "name": "Can you clean hacked websites and secure them long term?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. We handle malware cleanup, backdoor removal, hardening, and long-term monitoring to reduce repeat incidents."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Web Security & Protection", "item": "https://veerhan.com/services/web-security-protection" }
  ]
}
</script>
@endsection
...
<!-- ============================================================
  SERVICE HERO
============================================================ -->
<section class="service-hero" id="home" aria-label="Web Security and Protection Service Introduction">
  ...
  <div class="service-hero-inner">
    ...
    <div class="service-hero-left">
      <div class="service-hero-label" id="heroLabel">Web Security & Protection</div>
      <h1 class="service-hero-title" id="heroTitle">
        Secure Websites.<br><span class="accent">Protected Data.</span><br>Zero Compromise<br><span class="accent">Uptime.</span>
      </h1>
      <p class="service-hero-sub" id="heroSub">
        We secure websites and web applications for businesses in India, the USA, and Dubai. From vulnerability audits to active hardening, we protect your digital assets against real-world threats.
      </p>
      <div class="hero-actions" id="heroActions">
        <a href="{{ route('contact') }}#contact" class="btn-primary">Book Security Audit →</a>
        <a href="#portfolio" class="btn-secondary">See Security Cases ↗</a>
      </div>
      <div class="hero-stats-strip" id="heroStats">
        <div class="hstat">
          <div class="hstat-num">150<span>+</span></div>
          <div class="hstat-label">Security Audits Completed</div>
        </div>
        <div class="hstat">
          <div class="hstat-num">99.9<span>%</span></div>
          <div class="hstat-label">Uptime Protection Focus</div>
        </div>
        <div class="hstat">
          <div class="hstat-num">24<span>/7</span></div>
          <div class="hstat-label">Threat Monitoring Ready</div>
        </div>
        <div class="hstat">
    ...
    <div class="service-hero-visual" id="heroVisual">
      <div class="hero-visual-inner">
        <div style="width:88%; background:#111; border-radius:14px; box-shadow:0 24px 80px rgba(0,0,0,0.28); padding:16px; color:#fff;">
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
            <strong style="font-size:13px;">Security Operations</strong>
            <span style="font-size:11px; color:rgba(255,255,255,0.6);">Live Status</span>
          </div>
          <div style="display:grid; grid-template-columns:120px 1fr; gap:12px; align-items:center;">
            <div style="width:120px; height:120px; border-radius:50%; border:2px solid #F46B1B; display:flex; align-items:center; justify-content:center; flex-direction:column;">
              <div style="font-size:26px;">🛡️</div>
              <div style="font-size:11px; color:rgba(255,255,255,0.8);">Threat Score</div>
              <div style="font-size:17px; font-weight:700;">97/100</div>
            </div>
            <div style="display:flex; flex-direction:column; gap:8px;">
              <div style="background:rgba(255,255,255,0.06); border-radius:10px; padding:8px 10px; font-size:12px;">✓ Malware signatures cleaned</div>
              <div style="background:rgba(255,255,255,0.06); border-radius:10px; padding:8px 10px; font-size:12px;">✓ WAF rules applied</div>
              <div style="background:rgba(255,255,255,0.06); border-radius:10px; padding:8px 10px; font-size:12px;">✓ Admin hardening complete</div>
            </div>
          </div>
        </div>
      </div>
      <div class="hero-visual-chips">
        <div class="hero-chip"><span class="dot"></span> Vulnerability Scan</div>
        <div class="hero-chip"><span class="dot"></span> Malware Cleanup</div>
        <div class="hero-chip"><span class="dot"></span> WAF Setup</div>
        <div class="hero-chip"><span class="dot"></span> SSL Hardening</div>
      </div>
    </div>
  </div>
</section>
...
<div class="marquee-section" aria-hidden="true">
  <div class="marquee-track">
    <div class="marquee-item">Security Audit <span class="sep">✦</span></div>
    <div class="marquee-item">Malware Removal <span class="sep">✦</span></div>
    <div class="marquee-item">Firewall Setup <span class="sep">✦</span></div>
    <div class="marquee-item">Server Hardening <span class="sep">✦</span></div>
    <div class="marquee-item">SSL & HTTPS <span class="sep">✦</span></div>
    <div class="marquee-item">Security Monitoring <span class="sep">✦</span></div>
    <div class="marquee-item">Patch Management <span class="sep">✦</span></div>
    <div class="marquee-item">Backup & Recovery <span class="sep">✦</span></div>
    <div class="marquee-item">Incident Response <span class="sep">✦</span></div>
  ...
  <div class="build-grid">
    ...
    <div class="build-card">
      ...
      <div class="build-list">
        ...
        <div class="build-list-item">Security plugin hardening</div>
    ...
    <div class="build-card">
      ...
      <p>Security architecture and hardening for complex platforms, dashboards, portals, and SaaS applications.</p>
      <div class="build-list">
...
<section class="tech-stack" id="tech-stack" aria-labelledby="techTitle">
  ...
  <div class="tech-grid">
    ...
    <div class="tech-category">
      ...
      <div class="tech-tags">
        <span class="tech-tag">WAF Rulesets</span>
    ...
    <div class="portfolio-track" id="portfolioTrack">
      ...
      <div class="portfolio-card">
        ...
        <div class="portfolio-info">
          <div class="portfolio-tags">
            <span class="portfolio-tag">Vulnerability Audit</span>
            <span class="portfolio-tag">Remediation</span>
      ...
      <div class="portfolio-card">
        ...
        <div class="portfolio-info">
          ...
          <p>Incident response and hardening for a Texas SaaS platform after credential stuffing and malicious bot attacks.</p>
        </div>
      </div>
...
<section class="regions" id="regions" aria-labelledby="regionsTitle">
  ...
  <div class="regions-grid">
    ...
    <div class="region-card">
      ...
      <p>Indian businesses rely on us for proactive website security hardening, rapid remediation, and practical protection strategies.</p>
...
<section class="pricing" id="pricing" aria-labelledby="pricingTitle">
  ...
  <div class="pricing-grid">
    ...
    <div class="pricing-card featured">
      ...
      <a href="{{ route('contact') }}#contact" class="btn-pricing">Start Security Plan →</a>
    </div>
    ...
    <div class="pricing-card">
      ...
      <div class="pricing-features">
        ...
        <div class="pricing-feat"><div class="pricing-feat-check">✓</div>Secure architecture review</div>
...
<section class="faq" id="faq" aria-labelledby="faqTitle">
  ...
  <div class="faq-list" role="list">
    ...
    <div class="faq-item" role="listitem">
      ...
      <div class="faq-a"><div class="faq-a-inner">Security projects generally start from ₹12,000 for focused audit and cleanup scopes, and scale with website size, platform complexity, and monitoring requirements.</div></div>
    </div>

    <div class="faq-item" role="listitem">
      <div class="faq-q" role="button" aria-expanded="false" tabindex="0">
        How fast can you complete an audit and fixes?
        <span class="faq-icon">+</span>
      </div>
      <div class="faq-a"><div class="faq-a-inner">Initial audits usually take 2–5 days. Critical issues are prioritised and fixed first, with full hardening timelines based on severity and platform complexity.</div></div>
    </div>

    <div class="faq-item" role="listitem">
      <div class="faq-q" role="button" aria-expanded="false" tabindex="0">
        Do you secure websites for clients in the USA and Dubai?
        <span class="faq-icon">+</span>
      </div>
      <div class="faq-a"><div class="faq-a-inner">Yes. We work with clients across India, the US, and UAE using remote-first workflows and secure remediation processes.</div></div>
    </div>

    <div class="faq-item" role="listitem">
      <div class="faq-q" role="button" aria-expanded="false" tabindex="0">
        Can you remove malware and prevent repeat attacks?
        <span class="faq-icon">+</span>
      </div>
      <div class="faq-a"><div class="faq-a-inner">Yes. We clean infected files, remove backdoors, patch vulnerabilities, and implement hardening plus monitoring to reduce reinfection risk.</div></div>
    </div>
    ...
    <div class="faq-item" role="listitem">
      ...
      <div class="faq-a"><div class="faq-a-inner">Yes. We offer monthly protection plans including log monitoring, patch cycles, integrity checks, and proactive risk alerts.</div></div>
    </div>

    <div class="faq-item" role="listitem">
      <div class="faq-q" role="button" aria-expanded="false" tabindex="0">
        What happens after the initial security hardening?
        <span class="faq-icon">+</span>
      </div>
      <div class="faq-a"><div class="faq-a-inner">We provide a remediation report, preventive controls checklist, and optional ongoing security management to keep your platform hardened.</div></div>
    </div>
...
@include('partials.contact-form', ['serviceName' => 'Web Security & Protection', 'pageSource' => 'Web Security Service Page', 'formId' => 'security'])

<!-- CTA STRIP -->
<div class="cta-strip" aria-label="Call to action">
  <div class="cta-strip-text">
    <h2>Need to Lock Down Your Website?</h2>
    <p>Get a free vulnerability review and action plan within 24 hours.</p>
  </div>
