...
@section('head_meta')
<!-- ============================================================
  SEO META — AI Implementation Service Page
  Targets: India (Pune, Mumbai, Delhi, Bangalore), USA, Dubai
============================================================ -->
<title>AI Implementation Services | Veerhan – India, USA & Dubai</title>
<meta name="description" content="Veerhan helps businesses implement practical AI solutions across operations, marketing, support, and internal workflows. AI automation, assistants, integrations, and measurable efficiency systems.">
<meta name="keywords" content="ai implementation services India, business automation USA, ai workflow automation Dubai, ai assistant setup Pune, ai integration agency Mumbai, llm automation company, ai chatbot implementation, ai operations consulting">
...
<meta property="og:title" content="AI Implementation Services | Veerhan">
<meta property="og:description" content="Implement practical AI systems that save time, reduce cost, and improve business performance.">
<meta property="og:url" content="https://veerhan.com/services/ai-implementation">
<meta property="og:site_name" content="Veerhan">
<meta property="og:image" content="https://veerhan.com/og/ai-implementation-service.jpg">

<!-- Twitter Card -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="AI Implementation | Veerhan">
<meta name="twitter:description" content="AI automation, assistants, integrations, and business process optimisation for modern teams.">

<!-- Canonical -->
<link rel="canonical" href="https://veerhan.com/services/ai-implementation">

<!-- Hreflang for region targeting -->
<link rel="alternate" hreflang="en-in" href="https://veerhan.com/services/ai-implementation">
<link rel="alternate" hreflang="en-us" href="https://veerhan.com/services/ai-implementation">
<link rel="alternate" hreflang="en-ae" href="https://veerhan.com/services/ai-implementation">
<link rel="alternate" hreflang="x-default" href="https://veerhan.com/services/ai-implementation">
...
<script type="application/ld+json">
{
  ...
  "description": "AI implementation services for businesses in India, the USA, and Dubai. Includes workflow automation, AI assistants, knowledge systems, integration setup, and performance measurement.",
  "provider": {
    "@type": "Organization",
    "name": "Veerhan",
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How much do AI implementation services cost?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "AI implementation projects usually start around ₹30,000 for focused automation scopes and scale based on integrations, data readiness, and business complexity."
      }
    },
    {
      "@type": "Question",
      "name": "Do you offer AI implementation for Dubai businesses?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. We work with UAE businesses using remote-first collaboration to deploy practical AI workflows, assistants, and integrations."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Pilot implementations typically take 2–6 weeks depending on process complexity, system access, and data quality."
      }
    },
    {
      "@type": "Question",
      "name": "Can you implement AI without replacing our existing systems?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. We usually integrate with your existing tools first, so you get value quickly without disruptive platform changes."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "AI Implementation", "item": "https://veerhan.com/services/ai-implementation" }
  ]
}
</script>
@endsection
...
<!-- ============================================================
  SERVICE HERO
============================================================ -->
<section class="service-hero" id="home" aria-label="AI Implementation Service Introduction">
  ...
  <div class="service-hero-inner">
    ...
    <div class="service-hero-left">
      <div class="service-hero-label" id="heroLabel">AI Implementation</div>
      <h1 class="service-hero-title" id="heroTitle">
        Practical AI.<br><span class="accent">Real ROI.</span><br>Automations<br><span class="accent">That Work.</span>
      </h1>
      <p class="service-hero-sub" id="heroSub">
        We help businesses implement useful AI systems across operations, support, marketing, and internal workflows. No hype, just measurable productivity and better decisions.
      </p>
      <div class="hero-actions" id="heroActions">
        <a href="{{ route('contact') }}#contact" class="btn-primary">Book AI Discovery Call →</a>
        <a href="#portfolio" class="btn-secondary">See AI Use Cases ↗</a>
      </div>
      <div class="hero-stats-strip" id="heroStats">
        <div class="hstat">
          <div class="hstat-num">40<span>+</span></div>
          <div class="hstat-label">Automations Implemented</div>
        </div>
        <div class="hstat">
          <div class="hstat-num">60<span>%</span></div>
          <div class="hstat-label">Avg. Time Saved</div>
        </div>
        <div class="hstat">
          <div class="hstat-num">3<span>x</span></div>
          <div class="hstat-label">Faster Internal Workflows</div>
        </div>
        <div class="hstat">
      ...
      <div class="hero-visual-inner">
        <div style="width:88%; background:#fff; border-radius:14px; box-shadow:0 24px 80px rgba(0,0,0,0.12); padding:16px;">
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
            <strong style="font-size:13px;">AI Workflow Map</strong>
            <span style="font-size:11px; color:#6B6B6B;">Pilot Environment</span>
          </div>
          <div style="display:flex; align-items:center; justify-content:space-between; gap:8px; margin-bottom:12px;">
            <div style="flex:1; background:#F5F5F3; border-radius:10px; padding:10px; font-size:12px; text-align:center;">Input<br><strong>Inbox</strong></div>
            <div style="color:#F46B1B; font-weight:700;">→</div>
            <div style="flex:1; background:#FFF0E6; border-radius:10px; padding:10px; font-size:12px; text-align:center;">AI Agent<br><strong>Classify</strong></div>
            <div style="color:#F46B1B; font-weight:700;">→</div>
            <div style="flex:1; background:#F5F5F3; border-radius:10px; padding:10px; font-size:12px; text-align:center;">Action<br><strong>CRM / Slack</strong></div>
          </div>
          <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:8px;">
            <div style="background:#F5F5F3; border-radius:10px; padding:10px;">
              <div style="font-size:11px; color:#6B6B6B;">Tasks Automated</div>
              <div style="font-size:17px; font-weight:700;">64%</div>
            </div>
            <div style="background:#F5F5F3; border-radius:10px; padding:10px;">
              <div style="font-size:11px; color:#6B6B6B;">Avg. Handling Time</div>
              <div style="font-size:17px; font-weight:700;">-41%</div>
            </div>
            <div style="background:#F5F5F3; border-radius:10px; padding:10px;">
              <div style="font-size:11px; color:#6B6B6B;">Human Review</div>
              <div style="font-size:17px; font-weight:700;">Enabled</div>
            </div>
          </div>
        </div>
      </div>
      <div class="hero-visual-chips">
        <div class="hero-chip"><span class="dot"></span> Workflow Automation</div>
        <div class="hero-chip"><span class="dot"></span> AI Assistants</div>
        <div class="hero-chip"><span class="dot"></span> Tool Integrations</div>
        <div class="hero-chip"><span class="dot"></span> Human-in-the-Loop</div>
      </div>
    </div>
  </div>
</section>
...
<div class="marquee-section" aria-hidden="true">
  <div class="marquee-track">
    <div class="marquee-item">AI Workflow Audit <span class="sep">✦</span></div>
    <div class="marquee-item">AI Assistants <span class="sep">✦</span></div>
    <div class="marquee-item">Prompt Systems <span class="sep">✦</span></div>
    <div class="marquee-item">Knowledge Base AI <span class="sep">✦</span></div>
    <div class="marquee-item">Automation Pipelines <span class="sep">✦</span></div>
    <div class="marquee-item">CRM Integrations <span class="sep">✦</span></div>
    <div class="marquee-item">Sales AI Copilot <span class="sep">✦</span></div>
    <div class="marquee-item">Ops Automation <span class="sep">✦</span></div>
    <div class="marquee-item">AI Governance <span class="sep">✦</span></div>
  ...
  <div class="build-grid">
    ...
    <div class="build-card">
      ...
      <div class="build-list">
        ...
        <div class="build-list-item">AI-powered process automation</div>
    ...
    <div class="build-card">
      ...
      <p>AI-enabled workflow systems for operations, support, CRM, and internal knowledge automation.</p>
      <div class="build-list">
...
<section class="tech-stack" id="tech-stack" aria-labelledby="techTitle">
  ...
  <div class="tech-grid">
    ...
    <div class="tech-category">
      ...
      <div class="tech-tags">
        <span class="tech-tag">Automation Engines</span>
    ...
    <div class="portfolio-track" id="portfolioTrack">
      ...
      <div class="portfolio-card">
        ...
        <div class="portfolio-info">
          <div class="portfolio-tags">
            ...
            <span class="portfolio-tag">AI Workflow</span>
      ...
      <div class="portfolio-card">
        ...
        <div class="portfolio-info">
          ...
          <p>AI operations copilot implementation for a Texas service business, reducing repetitive manual tasks across teams.</p>
        </div>
      </div>
...
<section class="regions" id="regions" aria-labelledby="regionsTitle">
  ...
  <div class="regions-grid">
    ...
    <div class="region-card">
      ...
      <p>Indian teams use our AI implementation services to reduce repetitive work, improve decision speed, and scale operations efficiently.</p>
...
<section class="pricing" id="pricing" aria-labelledby="pricingTitle">
  ...
  <div class="pricing-grid">
    ...
    <div class="pricing-card featured">
      ...
      <a href="{{ route('contact') }}#contact" class="btn-pricing">Start AI Implementation →</a>
    </div>
    ...
    <div class="pricing-card">
      ...
      <div class="pricing-features">
        ...
        <div class="pricing-feat"><div class="pricing-feat-check">✓</div>LLM + integration architecture</div>
...
<section class="faq" id="faq" aria-labelledby="faqTitle">
  ...
  <div class="faq-list" role="list">
    ...
    <div class="faq-item" role="listitem">
      ...
      <div class="faq-a"><div class="faq-a-inner">AI implementation projects usually start around ₹30,000 for focused scopes and scale based on process complexity, integrations, and training requirements.</div></div>
    </div>
    ...
    <div class="faq-item" role="listitem">
      ...
      <div class="faq-a"><div class="faq-a-inner">Most pilot implementations take 2–6 weeks depending on workflow complexity, data quality, and integration access.</div></div>
    </div>

    <div class="faq-item" role="listitem">
      <div class="faq-q" role="button" aria-expanded="false" tabindex="0">
        Do you provide AI implementation for USA and Dubai clients?
        <span class="faq-icon">+</span>
      </div>
      <div class="faq-a"><div class="faq-a-inner">Yes. We work with businesses across India, the US, and UAE through remote-first implementation and clear rollout plans.</div></div>
    </div>

    <div class="faq-item" role="listitem">
      <div class="faq-q" role="button" aria-expanded="false" tabindex="0">
        Can AI implementation work with our current tools?
        <span class="faq-icon">+</span>
      </div>
      <div class="faq-a"><div class="faq-a-inner">Yes. We usually integrate AI into your existing stack first, so you get value quickly without replacing your entire system.</div></div>
    </div>

    <div class="faq-item" role="listitem">
      <div class="faq-q" role="button" aria-expanded="false" tabindex="0">
        Do you provide team training after implementation?
        <span class="faq-icon">+</span>
      </div>
      <div class="faq-a"><div class="faq-a-inner">Yes. We include playbooks, usage guidelines, and practical team onboarding so your staff can use new AI workflows confidently.</div></div>
    </div>

    <div class="faq-item" role="listitem">
      <div class="faq-q" role="button" aria-expanded="false" tabindex="0">
        What happens after the AI pilot goes live?
        <span class="faq-icon">+</span>
      </div>
      <div class="faq-a"><div class="faq-a-inner">We monitor adoption, tune prompts and logic, track outcomes, and optionally scale successful automations across additional teams.</div></div>
    </div>
...
@include('partials.contact-form', ['serviceName' => 'AI Implementation', 'pageSource' => 'AI Implementation Service Page', 'formId' => 'ai'])

<!-- CTA STRIP -->
<div class="cta-strip" aria-label="Call to action">
  <div class="cta-strip-text">
    <h2>Ready to Implement Useful AI?</h2>
    <p>Get a free AI opportunity audit and rollout plan in 24 hours.</p>
  </div>
